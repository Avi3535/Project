...
def main(y_col, norm, split_val):
    ...
    def training(w):        
        ...
        l7 = Label(gui, text="Mean Squared Error:" + str(np.mean(ytr - y_pred)**2), font=("Open Sans",14))
    ...
    def testing(w):
        ...
        l8 = Label(gui, text="Mean Squared Error:" + str(np.mean(yte - y_predt)**2), font=("Open Sans",14))
    ...
    def iterations():
        ...
        l11 = Label(gui, text="lr:", font=("Open Sans",14))
    ...
    Radiobutton(gui, text="Use Iterative Model", variable=ra, value=2, command=lambda: iterations()).grid(row=8, column=1)
